...
class ParserTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.parser = sandy2.parsing.Parser(micro_parsers=[mp], actions=[])
    ...
    def testTopSort(self):
        ...
        ordered = sandy2.ordering.topological_sort(micro_parsers)
...
class DummyMicroParser(sandy2.parsing.IMicroParser):
