...
class ReceiveEmail:
	...
	# <DataStore.addEvent>. Multiple (or no) events may be added, depending on how many
	...
	# Method: lookupEvents
	# Parses <Email.message> from *email* and calls <DataStore.textSearchEvents>, <DataStore.timeSearchEvents>, or <DataStore.tagSearchEvents>. Sends reply to the user.
	#
	# Parameters:
	#   email - <Email> object
	#
	...
	# <DataStore.idSearchEvents>. The returned <Event> object is modified and passed to
	# <DataStore.updateEvent>. Sends confirmation email to the user.
	#
	# Parameters:
	#   email - <Email> object
	#
